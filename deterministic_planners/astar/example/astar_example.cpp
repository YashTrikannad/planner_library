...
int main()
{
    ...
    auto EigenGraph = pl::graph::cost_graph<pl::graph::eigen_graph, Eigen::MatrixXd>{EigenMap};

    // Set Up Planner
    pl::algorithms::astar<pl::graph::cost_graph<pl::graph::eigen_graph, Eigen::MatrixXd>,
