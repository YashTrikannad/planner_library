...
template<typename DataType>
std::optional<typename graph<std::vector<std::vector<DataType>>, DataType>::node_type> graph<std::vector<std::vector<DataType>>, DataType>::get_adjacent_node(const node_type &node, common::search_direction direction) const
{
    switch (direction)
    {
        case common::search_direction::top:
            get_adjacent_node_with_check_(node, common::up{});
        case common::search_direction::top_right:
            get_adjacent_node_with_check_(node, common::top_right{});
        case common::search_direction::right:
            get_adjacent_node_with_check_(node, common::right{});
        case common::search_direction::bottom_right:
            get_adjacent_node_with_check_(node, common::bottom_right{});
        case common::search_direction::bottom:
            get_adjacent_node_with_check_(node, common::down{});
        case common::search_direction::bottom_left:
            get_adjacent_node_with_check_(node, common::bottom_left{});
        case common::search_direction::left:
            get_adjacent_node_with_check_(node, common::left{});
        case common::search_direction::top_left:
            get_adjacent_node_with_check_(node, common::top_left{});
        default:
            std::__throw_runtime_error("Given direction not known");
    }
