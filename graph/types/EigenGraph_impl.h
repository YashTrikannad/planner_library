...
void graph<Eigen::Matrix<DataType, Eigen::Dynamic, Eigen::Dynamic>, DataType>::for_each_adjacent_node(const node_type &node, Func &&func) const
{
    if constexpr (N == 4)
    {
...
template <typename DataType>
auto graph<Eigen::Matrix<DataType, Eigen::Dynamic, Eigen::Dynamic>, DataType>::get_4_neighbor(const node_type& node) const
{
...
template <typename DataType>
auto graph<Eigen::Matrix<DataType, Eigen::Dynamic, Eigen::Dynamic>, DataType>::get_8_neighbor(const node_type& node) const
{
